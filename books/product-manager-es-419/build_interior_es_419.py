#!/usr/bin/env python3
"""
build_interior_es_419.py
Build KDP print interior PDF for the Spanish (Latin America) edition of "Product Manager?"
Output: ../../_kdp/product-manager-interior-es-419.pdf
...
OUT_PDF  = OUT_DIR / "product-manager-interior-es-419.pdf"
...
print(f"Rendering Spanish (Latin America) PDF → {OUT_PDF}")
