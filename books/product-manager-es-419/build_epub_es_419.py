#!/usr/bin/env python3
"""
build_epub_es_419.py
Build EPUB for the Spanish (Latin America) edition of "Product Manager?"
Output: ../../_kdp/product-manager-es-419.epub

Requires: ebooklib, pip install ebooklib
Run from: books/product-manager-es-419/
"""
...
OUT_EPUB = OUT_DIR / "product-manager-es-419.epub"
OUT_DIR.mkdir(exist_ok=True)

# ── Chapter order and titles ───────────────────────────────────────────────────
CHAPTERS = [
    ("thanks.html",        "Agradecimientos",                   None),
    ("index.html",         "Prefacio",                          None),
    ("what-pms-do.html",   "Capítulo 1. ¿Qué hacen realmente los PMs?",            "1"),
    ("traits.html",        "Capítulo 2. Las cualidades que la IA no reemplaza",    "2"),
    ("how-pms-think.html", "Capítulo 3. Cómo piensan los PMs",                     "3"),
    ("peers.html",         "Capítulo 4. Los pares y el mapa de poder",             "4"),
    ("tools.html",         "Capítulo 5. Las herramientas — aunque no se trata de ellas", "5"),
    ("do-you-like-it.html","Capítulo 6. ¿Te va a gustar este trabajo?",            "6"),
    ("paths.html",         "Capítulo 7. Caminos de entrada y de salida",           "7"),
    ("next.html",          "Capítulo 8. Qué sigue",                                "8"),
    ("appendix.html",      "Capítulo 9. Apéndice: leer la sala en 2026",           "9"),
    ("references.html",    "Referencias",                       None),
    ("author.html",        "Sobre el autor",                    None),
]
...
# ── Build EPUB ─────────────────────────────────────────────────────────────────
book = epub.EpubBook()
book.set_identifier("patrickthoffman-product-manager-es-419-2026")
book.set_title("¿Product Manager?")
book.set_language("es")
book.add_author("Patrick T. Hoffman")
book.add_metadata("DC", "description",
    "Una guía práctica para quien está evaluando si el product management es lo suyo — escrita después de que la IA cambió este trabajo.")
...
# Write
print(f"Writing Spanish (Latin America) EPUB → {OUT_EPUB}")
