...
"""
build_epub_es_es.py
Build EPUB for the Spanish (Spain) edition of "Product Manager?"
Output: ../../_kdp/product-manager-es-es.epub
...
OUT_EPUB = OUT_DIR / "product-manager-es-es.epub"
...
# ── Build EPUB ─────────────────────────────────────────────────────────────────
book = epub.EpubBook()
book.set_identifier("patrickthoffman-product-manager-es-es-2026")
...
# Write
print(f"Writing Spanish (Spain) EPUB → {OUT_EPUB}")
