#!/usr/bin/env python3
"""
build_interior_fr.py
Build KDP print interior PDF for the French edition of "Product Manager?"
Output: ../../_kdp/product-manager-interior-fr.pdf
...
OUT_PDF  = OUT_DIR / "product-manager-interior-fr.pdf"
...
print(f"Rendering French PDF → {OUT_PDF}")
